...
def evaluate_policy(
    ...
    episode_successes = np.zeros(n_envs, dtype="bool")
    ...
    while (episode_counts < episode_count_targets).any():
        ...
        successes = [info.get("success", False) for info in infos]
        # print(current_lengths, successes, dones, episode_counts)
        episode_successes |= np.array(successes, dtype="bool")
        ...
        for i in range(n_envs):
            if episode_counts[i] < episode_count_targets[i]:
                ...
                if dones[i] or timestep >= 200:
                    ...
                    current_rewards[i] = 0
                    current_lengths[i] = 0
                    all_episode_successes.append(episode_successes[i])
    ...
    success_rate = np.mean(all_episode_successes)
